...
public class Program {
            ...
            for (int j = 0; j < array.length; j++) {
                if (array[i][j] != 0 && array[i][j] != 1)
                    throw new RuntimeException(
                            String.format("Некорректное значение элемента по индексу [%d][%d] = %d", i, j,
                                    array[i][j]));
                else {
                    sum += array[i][j];
                }
     ...
     * @throws CustomArraySizeException Кол-во элементов массива должно быть
     *                                  одинаковым
     */
    static int[] getSumArray(int[] array1, int[] array2) throws NullPointerException, CustomArraySizeException {
        ...
        if (array1.length != array2.length)
            throw new CustomArraySizeException("Кол-во элементов массива должно быть одинаковым.", array1.length,
                    array2.length);
